 ...
 */
public class Program04_NumbersOfDaysInMonth {
    public static void main(String[] args) {
        ...
        System.out.println(getDaysofMonth(1, 2020));
        System.out.println(getDaysofMonth(2, 2018));
        System.out.println(getDaysofMonth(-1, 2020));
        System.out.println(getDaysofMonth(1, -2020));

    }

    //checking if year is leapyear or not
    ...
    //calculating days of month depending on year
